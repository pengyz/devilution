...
int DRLG_PlaceMiniSet(unsigned char *miniset, int tmin, int tmax, int cx, int cy, bool setview, int noquad, int ldir)
{
...
void L5roomGen(int x, int y, int w, int h, bool dir)
{
	int v5; // eax
	int v6; // ecx
	int v7; // eax
