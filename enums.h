...
{
    WM_DIAB = WM_USER + 1,
    WM_DIABNEXTLVL = WM_USER + 2,
    WM_DIABPREVLVL = WM_USER + 3,
    WM_DIABRTNLVL = WM_USER + 4,
    WM_DIABSETLVL = WM_USER + 5,
    WM_DIABWARPLVL = WM_USER + 6,
    WM_DIABTOWNWARP = WM_USER + 7,
    WM_DIABTWARPUP = WM_USER + 8,
    WM_DIABRETOWN = WM_USER + 9,
    WM_DIABNEWGAME = WM_USER + 10,
    WM_DIABLOADGAME = WM_USER + 11
