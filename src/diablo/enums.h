...
{
    WM_DEFAULT = 400,
    WM_DIAB = WM_DEFAULT + 1,
    WM_DIABNEXTLVL = WM_DEFAULT + 2,
    WM_DIABPREVLVL = WM_DEFAULT + 3,
    WM_DIABRTNLVL = WM_DEFAULT + 4,
    WM_DIABSETLVL = WM_DEFAULT + 5,
    WM_DIABWARPLVL = WM_DEFAULT + 6,
    WM_DIABTOWNWARP = WM_DEFAULT + 7,
    WM_DIABTWARPUP = WM_DEFAULT + 8,
    WM_DIABRETOWN = WM_DEFAULT + 9,
    WM_DIABNEWGAME = WM_DEFAULT + 10,
    WM_DIABLOADGAME = WM_DEFAULT + 11
